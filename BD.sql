...
CREATE TABLE `nominas` (
	...
	`dni` VARCHAR(10) NULL DEFAULT NULL COLLATE 'latin1_swedish_ci',
	`sueldo` DECIMAL(10,2) NULL DEFAULT NULL,
	PRIMARY KEY (`id`) USING BTREE,
	INDEX `dni` (`dni`) USING BTREE,
	CONSTRAINT `nominas_ibfk_1` FOREIGN KEY (`dni`) REFERENCES `empleados` (`dni`) ON UPDATE RESTRICT ON DELETE RESTRICT
)
COLLATE='latin1_swedish_ci'
ENGINE=InnoDB
AUTO_INCREMENT=44
